...
class App extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      timing:['Dark Street lights on', 'Day', 'Dusk/Dawn', 'Dark No street lights', 'Dark Street lights unknown'],
